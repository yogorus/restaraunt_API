...
# Code is designed to throw an error if parent menu and submenu doesn't exist, but test expects an empty output and 200 status code, so no dependencies in this route
